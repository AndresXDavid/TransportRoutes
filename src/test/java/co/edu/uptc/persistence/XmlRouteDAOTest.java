 ...
 * en formato XML.
 */
public class XmlRouteDAOTest implements RouteDAO {
     ...
     public void save(RouteTree tree, String filePath) {
          try {
               ...
               System.out.println("DEBUG: XmlRouteDAO.save() - Guardando en: " + filePath);
     ...
     public RouteTree load(String filePath) {
          try {
               System.out.println("DEBUG: XmlRouteDAO.load() - Cargando desde: " + filePath);
